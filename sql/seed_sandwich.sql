...
-- Run after schema.sql:  psql -d <dbname> -f seed_sandwich.sql
-- ============================================================================
...
WHERE o.table_number = 1 AND o.restaurant_id = 1 AND mi.name = 'Classic Club' AND mi.category_id = 1
LIMIT 1;

INSERT INTO order_item (quantity, unit_price, special_instructions, order_id, menu_item_id)
SELECT 2, mi.price, '', o.id, mi.id
FROM orders o, menu_item mi
WHERE o.table_number = 1 AND o.restaurant_id = 1 AND mi.name = 'Philly Cheesesteak' AND mi.category_id = 1
LIMIT 1;
